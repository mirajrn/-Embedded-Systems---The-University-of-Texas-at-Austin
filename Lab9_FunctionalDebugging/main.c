...
// Lab 9
// Authors: Basic Version: Jonathan Valvano and Ramesh Yerraballi
// Authors: Modification for the project: Rashed Hossain Miraj 
...
int main(void){  unsigned long i,last,now;
  ...
  while(1){
	if(SW1 == 0x00 || SW2 == 0x00) {
		while(SW1 == 0x00 || SW2 == 0x00) {		// while switches pressed toggle LED
			LED ^= 0x02;
